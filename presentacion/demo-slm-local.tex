...
\begin{frame}{El techo}
  ...
  \begin{tabular}{@{}lcccc@{}}
    ...
    \midrule
    4 Codificación & \mal{1/16} & \mal{2/16} & \mal{5/16} & \bien{16/16} \\
  ...
  \textbf{Sólo es posible porque el informe es sintético}, y \alert{no es una
  medición ciega}: se produjo con los patrones de evaluación a la vista.\\
  Dice qué admite cada tarea —la 4 tiene solución— no cuánto separa a un modelo
  de otro.
  \end{center}
  \vspace{.4em}
